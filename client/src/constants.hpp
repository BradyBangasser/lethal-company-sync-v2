...
inline const std::string cachePath(const std::string subpath) {
    return fmt::format("{}{}{}{}{}", LCS_PROGRAM_FILES, PATH_SLASH, LCS_CACHE_FOLDER, PATH_SLASH, subpath);
}

inline const std::string tmpPath(const std::string subpath) {
    return fmt::format("{}{}{}{}{}", LCS_PROGRAM_FILES, PATH_SLASH, LCS_TMP_FOLDER, PATH_SLASH, subpath);
}

inline const std::string lcsPath(const std::string subpath) {
    return fmt::format("{}{}{}", LCS_PROGRAM_FILES, PATH_SLASH, subpath);
}

inline const std::string installPath(const std::string subpath) {
    return fmt::format("{}{}{}{}{}", LCS_PROGRAM_FILES, PATH_SLASH, LCS_INSTALLS_FOLDER, PATH_SLASH, subpath);
}
